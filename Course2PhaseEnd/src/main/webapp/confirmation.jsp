...
<b>Your flight has been booked!</b><br>
...
The details are listed below.</b><br>
...
<b>Total Price: </b> $<%=totalPrice %><br><br>

To book an additional flight, please click <a href="search.jsp">here</a>.<br>
If you are finished with booking, you may close this window.<br><br>
...
//--> Need to get the airline object

ConfirmedFlights confirmed = new ConfirmedFlights(firstName, lastName, billingAddress, state, zipcode, airlinename, flightNum, numPassInt);

	// -->Update the capacity of the airline by decrementing by one
...
trans.commit();
sess.close();
//--> Need to be able to decrease the capacity on the flight after successful booking
%>
